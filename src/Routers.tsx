...
import Funnel3 from './pages/funnel3';
import Calender from './form';
import Funnel from './pages/homePages/funnel2';
const Routers = () => {
    return (
        <>
            <Routes>
                <Route path="/" element={<Home />} ></Route>
                <Route path="/funnel3" element={<Funnel3 />} ></Route>
                <Route path="/funnel" element={<Funnel />} ></Route>
                <Route path="/:username" element={<HomeDark />} ></Route>
